...
用 Git Pusher 匯入 `StudyBase V2.1.7.zip` → 推 main，然後 Settings → Pages → Source: main → `/(root)`。約 1-2 分鐘上線。PWA 在 HTTPS 的 Pages 上才會出現「加入主畫面 / 安裝」。
